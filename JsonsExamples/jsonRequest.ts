export const themeOne = {
  ...
  pages: {
    index: {
      ...
      footer:{
          columnOne:{
              description:'um has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was',
          },
          columnTwo:{
              socialMedia:{
                  facebook:{
                      img: "https://i.pinimg.com/originals/ce/c8/a6/cec8a6239de29acbfcfee0ccec995b9f.png",
                      link: "https://www.facebook.com/"
                  },
                  instagram:{
                      img:  "https://i.pinimg.com/originals/66/41/c9/6641c94e15a0be37af49a4250386c03e.png",
